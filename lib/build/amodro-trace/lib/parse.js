...
/*global define: false */
define(['espree', './lang'], function (espree, lang) {
    'use strict';
    ...
    //From an espree example for traversing its ast.
    ...
    function parse(moduleName, fileName, fileContents, options) {
        ...
        var i, moduleCall, depString,
            ...
            moduleList = [],
            needsDefine = true,
            astRoot = espree.parse(fileContents);
    ...
    parse.definesRequire = function (fileName, fileContents) {
        ...
        traverse(espree.parse(fileContents), function (node) {
    ...
    parse.getAnonDeps = function (fileName, fileContents) {
        var astRoot = typeof fileContents === 'string' ?
                      espree.parse(fileContents) : fileContents,
    ...
    parse.getAllNamedDefines = function (fileContents, excludeMap) {
        var names = [];
        parse.recurse(espree.parse(fileContents),
     ...
     * espree.parse() with loc was done.
